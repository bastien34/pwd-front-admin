...
class AdminIndex(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'site_admin/site-admin.html'


class SiteSettingsUpdate(LoginRequiredMixin, UpdateView):
    template_name = "site_admin/admin/form_page.html"
    model = SiteSettings
    fields = ['site_name',
              'company_name',
              'address',
    ...
    def get_success_url(self):
        return reverse("pwd_front_admin:preferences-update",
...
class SliderListView(SliderBaseView, ListView):
    template_name = "site_admin/admin/slider_list.html"


class SliderCreateView(LoginRequiredMixin, AjaxableResponseMixin, CreateView):
    template_name = "site_admin/admin/form_page.html"
...
class SliderUpdateView(SliderBaseView, AjaxableResponseMixin, UpdateView):
    ...
    extra_context = {'page_name': _('Slider update'),
                     'menu_slider': True, }
    success_url = "/site-admin/slider-list"
    ...
    def delete_url(self):
        return reverse_lazy("pwd_front_admin:slider-delete",
                            kwargs={'pk': self.object.pk})


class SliderDeleteView(SliderBaseView, DeleteMessageMixin, DeleteView):
    success_msg = _("Slider deleted")
    success_url = reverse_lazy("pwd_front_admin:slider-list")
...
class BlurbListView(LoginRequiredMixin, ListView):
    model = Blurb
    template_name = "site_admin/admin/blurb_list.html"
...
class BlurbUpdateView(LoginRequiredMixin, AjaxableResponseMixin, UpdateView):
    ...
    extra_context = {'page_name': _('Blurb update'),
                     'menu_blurb': True}
    success_url = reverse_lazy("pwd_front_admin:blurb-list")

    def delete_url(self):
        return reverse_lazy("pwd_front_admin:blurb-delete",
                            kwargs={'pk': self.object.pk})
...
class ContentListView(LoginRequiredMixin, AjaxableResponseMixin, ListView):
    model = Paragraph
    template_name = "site_admin/admin/content_list.html"
...
class ContentCreateView(LoginRequiredMixin, AjaxableResponseMixin, CreateView):
    ...
    success_url = reverse_lazy("pwd_front_admin:content-list")
...
class ContentUpdateView(LoginRequiredMixin, AjaxableResponseMixin, UpdateView):
    ...
    extra_context = {'page_name': _('Content update'),
                     'content_menu': True, }
    success_url = "/site-admin/content-list"

    def delete_url(self):
        return reverse_lazy("pwd_front_admin:content-delete",
                            kwargs={'pk': self.object.pk})
...
class PageListView(LoginRequiredMixin, ListView):
    model = Page
    template_name = "site_admin/admin/page_list.html"
...
class PageUpdateView(LoginRequiredMixin, AjaxableResponseMixin, UpdateView):
    ...
    success_url = reverse_lazy("pwd_front_admin:page-list")
